...
trait miniCAnalyzerSign extends miniCControlFlow with miniCError with Sign {
    /*
    ...
    */
    ...
    def analyze(scalarExpr: ScalarExpr, env: AbsEnv): Sign = scalarExpr match {
    ...
    def analyze(prog: ProgramL, nextMap: NextMap): AbsState = {
        ...
        */
        ...
        // Run the framework
        val initState = transfer(Map(prog.cmd -> Map[String, Sign]()))
    ...
    def analyze_sign(prog: Program): AbsState = {
